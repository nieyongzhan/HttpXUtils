...
public class HttpUtilsActivity extends Activity implements RequestListener {
	...
	private void initListener() {
		btn_get.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				ServerRequest.requestGet(R.id.url_request_weather_query, params, HttpUtilsActivity.this, null);
			}
		});
	}
